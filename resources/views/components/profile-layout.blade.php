...
<div class="max-w-3xl mx-auto">
    ...
    <section class="grid grid-cols-12 p-2 my-5 lg:my-12 ">
        ...
        <aside class="col-span-8 lg:max-w-2xl lg:mx-auto flex flex-col gap-5">
            ...
            {{-- Actions --}}
            <section class="grid grid-cols-12 gap-5 mr-auto">
    ...
    <section class="border-t">
        <ul class="grid grid-cols-3 gap-4 max-w-sm mx-auto pb-3 ">
            {{-- Posts --}}
            <li class="flex items-center gap-2 py-2 cursor-pointer {{ request()->routeIs('profile.home', $user->username) ? 'border-t border-black' : '' }}">
            ...
            {{-- reels --}}
            <li class="flex items-center gap-2 py-2 cursor-pointer {{ request()->routeIs('profile.reels', $user->username) ? 'border-t border-black' : '' }}">
                {{-- border icon from bootsrap icons --}}
            ...
            @auth
                @if(auth()->user()->id == $user->id)
                    <li class="flex items-center gap-2 py-2 cursor-pointer {{ request()->routeIs('profile.saved', $user->username) ? 'border-t border-black' : '' }}">
