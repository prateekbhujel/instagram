<div class="  bg-white lg:h-[700px] flex flex-col gap-y-4 px-5 rounded-lg">
    ...
    <main class="grid lg:grid-cols-12 gap-3 h-full w-full overflow-hidden ">
        ...
        <aside class="lg:col-span-5 h-full border-l p-3 flex gap-4 flex-col overflow-hidden overflow-y-scroll">
            ...
            <div>
                ...
                <p class="mt-3 text-xs text-gray-400 dark:text-gray-600">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero ex ipsam quis dolorem aperiam tempora nesciunt modi mollitia! Consequatur totam cum ratione dolore ipsa recusandae vel obcaecati explicabo autem sit?</p>
            </div>
            ...
            <section class="" x-data="{open:false}">
                <button @click="open =! open"
                    ...
                    <div class="flex gap-1  items-center">
                        <h6 class=" text-gray-900 font-bold text-base">Advanced settings</h6>
                ...
                <ul x-cloak x-show="open" x-collapse class="  w-full space-y-2 py-2">
                    ...
                    <li>
                        ...
                        <p class="text-xs my-2 text-gray-600/80">
