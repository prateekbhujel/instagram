<div  class="grid lg:grid-cols-12 gap-3 h-full w-full overflow-hidden">
    ...
    <aside class="lg:col-span-5 h-full scrollbar-hide relative flex gap-4 flex-col overflow-hidden overflow-y-scroll">
        ...
        <header class="flex items-center gap-3 border-b py-2 sticky top-0 bg-white z-10 ">
            ...
            <x-avatar src="https://scontent.fbir7-1.fna.fbcdn.net/v/t39.30808-6/440466030_6871650512936763_6542344152271268454_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_ohc=1-v_381x69QQ7kNvgHBwDgp&_nc_ht=scontent.fbir7-1.fna&oh=00_AYCzL1da23tQyS7FfjQ75CgjDzj5vA38CT6rZr_W8Fv5sA&oe=66466206" class="h-9 w-9" />
           ...
           <section class="flex flex-col gap-2 py-2">
            ...
            {{-- Main Comment --}}
                <div class="flex items-center gap-2">
                    <x-avatar src="https://scontent.fbir7-1.fna.fbcdn.net/v/t39.30808-6/440466030_6871650512936763_6542344152271268454_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_ohc=1-v_381x69QQ7kNvgHBwDgp&_nc_ht=scontent.fbir7-1.fna&oh=00_AYCzL1da23tQyS7FfjQ75CgjDzj5vA38CT6rZr_W8Fv5sA&oe=66466206" class="h-9 w-9 mb-auto" />
                    ...
                    <div class="grid grid-cols-7 w-full gap-2">
                        ...
                        <div class="col-span-6 flex flex-wrap text-sm">
                            ...
                            <p>
                                <span class="font-bold text-sm">
                                    ...
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore maxime esse quis, praesentium sapiente ipsam facere pariatur hic .
                            </p>
                        ...
                        <div class="col-span-7 flex gap-2 text-sm items-center text-gray-700">
                            ...
                            <span>2d</span>
                            <span class="font-bold">333 Likes</span>
            ...
            <div class="flex items-center gap-3 w-11/12 ml-auto py-2">
                <x-avatar src="https://scontent.fbir7-1.fna.fbcdn.net/v/t39.30808-6/440466030_6871650512936763_6542344152271268454_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_ohc=1-v_381x69QQ7kNvgHBwDgp&_nc_ht=scontent.fbir7-1.fna&oh=00_AYCzL1da23tQyS7FfjQ75CgjDzj5vA38CT6rZr_W8Fv5sA&oe=66466206" class="h-8 w-8 mb-auto" />
