<div class="max-w-lg mx-auto">
    ...
    <hedaer class="flex items-center gap-3">
    ...
    <footer>
        ...
        {{-- Send, Bookmark and comments likes --}}
        ...
        {{-- Likes and Views --}}
        <p class="font-bold text-sm">104,4478 likes</p>

        {{-- Name and Comment --}}
        <div class="flex text-sm gap-2 font-medium">
            <p> <strong class="font-bold">{{ fake()->name }} </strong> 
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni fuga cum quibusdam beatae magnam molestiae sequi libero incidunt omnis unde quisquam repellendus cupiditate aperiam, iste nostrum nam nobis. Vero, iste?   
            </p>
        </div>

        {{-- view post modal --}}
        <button class="text-slate-500/90 text-sm font-medium"> View all 4,556 comments</button>
        ...
        <form x-data="{inputText:''}" class="grid grid-cols-12 items-center w-full">
            ...
            <div class="cols-span-1 ml-auto flex justify-end text-right">
                ...
                <span class="col-span-1 ml-auto px-1">
